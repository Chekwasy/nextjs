        ...
        <div className='container mx-auto px-4 flex justify-between'>
          ...
          <div className='hover:bg-green-200 rounded text-gray-700 hover:text-white flex items-center relative'>
              <div className=" md:hidden font-bold text-white ">
                { `${storeItems ? storeItems.mainSlice.me.currency : ''} ${storeItems ? typeof parseFloat(storeItems.mainSlice.me.accbal) === 'number' && new Intl.NumberFormat().format(parseFloat(storeItems.mainSlice.me.accbal)) : ''}` }
              </div>
          </div>
