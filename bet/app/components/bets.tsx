      ...
      {isOpen && (
            <div className=" bg-gray-200 flex flex-col md:w-4/5 w-11/12 mx-auto">
                <div className="bg-gray-200 rounded-lg w-full md:w-4/5 lg:w-7/10 xl:w-7/10 mx-auto p-4">
                  ...
                  <div key={index} className={`flex flex-col space-y-1 border-b-4 mb-4 border-gray-700 rounded-b-md ${item.mOutcome !== "Pending" ? (item.mOutcome === "Lost" ? "bg-red-500" : "bg-green-500") : "bg-gray-200" }`}>
