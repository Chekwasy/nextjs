  ...
  return (
    <div className="relative bg-white rounded-b-lg border-4 border-green-300 mt-16 lg:border-2 lg:w-4/5 mx-auto">
      <div className="absolute top-0 left-0 w-full bg-green-500 text-white p-4 rounded-t-lg flex justify-between items-center">
        ...
        <button aria-label="Open sidebar" onClick={() => setSidebarOpen(!sidebarOpen)} className="flex flex-col items-center">
          <div className="rounded-full mt-0 mb--20 bg-red-700 text-white">{storeItems.mainSlice.played.length === 0 ? '' : storeItems.mainSlice.played.length}</div>
